 ...
 * generated in the com.wscalculadora.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sumar_QNAME = new QName("http://ws.wscalculadora.com/", "sumar");
    private final static QName _SumarResponse_QNAME = new QName("http://ws.wscalculadora.com/", "sumarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wscalculadora.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.wscalculadora.com/", name = "sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.wscalculadora.com/", name = "sumarResponse")
